...
public class AdminController {
	...
	public ModelAndView Book_Management(String op)
	{
	    ...
	    if ("add".equals(op)) {
	        ...
	        mv.addObject("selectUpdate", "Update"); // ✅ THIS LINE
	    }
	...
	public ModelAndView book_Update(BookRegistration breg, String Book_title)
	{
	    ModelAndView mv = new ModelAndView("Book_Management");

	    Optional<BookRegistration> existing = brepo.findById(Book_title);

	    if(existing.isPresent())
	    {
	        brepo.save(breg); // update
